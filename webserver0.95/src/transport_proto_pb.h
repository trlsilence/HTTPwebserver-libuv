...
class Transport_proto_CHead : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:transport_proto.Transport_proto.CHead) */ {
 public:
  ...
  float usertype() const;
  void set_usertype(float value);
...
inline float Transport_proto_CHead::usertype() const {
  // @@protoc_insertion_point(field_get:transport_proto.Transport_proto.CHead.UserType)
  return usertype_;
}
inline void Transport_proto_CHead::set_usertype(float value) {
  set_has_usertype();
  usertype_ = value;
...
inline float Transport_proto_CHead::cmdtype() const {
  // @@protoc_insertion_point(field_get:transport_proto.Transport_proto.CHead.CmdType)
  return cmdtype_;
}
inline void Transport_proto_CHead::set_cmdtype(float value) {
  set_has_cmdtype();
  cmdtype_ = value;
...
inline float Transport_proto_CHead::stateid() const {
  // @@protoc_insertion_point(field_get:transport_proto.Transport_proto.CHead.StateID)
  return stateid_;
}
inline void Transport_proto_CHead::set_stateid(float value) {
  set_has_stateid();
  stateid_ = value;
...
inline float Transport_proto_CHead::rsptime() const {
  // @@protoc_insertion_point(field_get:transport_proto.Transport_proto.CHead.RspTime)
  return rsptime_;
}
inline void Transport_proto_CHead::set_rsptime(float value) {
  set_has_rsptime();
  rsptime_ = value;
