...
//公共部分
string Serialize_head::Serialhead(Serialize_head heads, float version, float usertype, float cmdtype, float stateid, float rsptime)
{
...
string Cbody_ReturnManagerIDtoCDN::Serial_ReturnManagerIDtoCDN(Cbody_ReturnManagerIDtoCDN report_ip, int managerid,int cdnid)  //manager前端
{
	string temp;
...
common Cbody_ReturnManagerIDtoCDN::Parse_ReturnManagerIDtoCDN(Cbody_ReturnManagerIDtoCDN report_ip, const string &stmp)  //CDN节点使用
{
	struct common comm;
...
string Cbody_AssignCDNRep::Serial_AssignCDNRep(Cbody_AssignCDNRep assigncdnRep, int cdnid, const string &requested_url)
{
	string temp;
